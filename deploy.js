...
function cloneRepo() {
	...
	cmd.get(
		'rm -rf starter-node-angular && git clone https://github.com/robbender/starter-node-angular.git',
...
function sshConnect() {
	...
	ssh.connect({
		...
		host: 'ec2-54-193-70-10.us-west-1.compute.amazonaws.com',
		username: 'ubuntu',
		privateKey: 'dep-final.pem'
	})
	.then(function() {
